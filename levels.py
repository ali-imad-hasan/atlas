...
plprms = { ('go3')  : { 'named_var' : 'ozone', 'units' : 'ppbv',  'mass_cf' : 28.97/48.*1e9,'cmap_name' : 'gist_ncar', \
           ...
           ('nox') : { 'named_var' : 'nitrogen family nox', 'units' : 'ug/kg', 'cmap_name' : 'gist_ncar', 'mass_cf' : 1.,\
                        'c_values' : [.01,.02,.03,.04,.05,.06,.07,.08,.09,.1,.11,.12,.13,.14,.15,.16,.17,.18,.19,\
                                           .2,.3,.4,.5,.6,.7,.8,.9,1.0] },\
           ('th')   : { 'named_var' : 'potential temperature', 'units' : 'k',  'mass_cf' : 1, 'cmap_name' : 'gray', \
                        'c_values' : [270,275,280,285,290,295,300,305,310,315,320,325,330,335,340,345,350,355, \
                                          360,365,370,375,380,385,390,395,400,410,420,430,440,450,460]} ,\
           ('pv')   : { 'named_var' : 'potential vorticity', 'units' : 'pvu',  'mass_cf' : 1e6, 'cmap_name' : '#333333', \
                        'c_values' : [2.0]} \
}
